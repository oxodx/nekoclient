...
public final class ProtectorTracker {
  ...
  public static void bootstrap() {
    ...
    try {
      ...
      org.slf4j.LoggerFactory.getLogger(ProtectorTracker.class)
        .warn("[Protector] Failed to bootstrap mod ID set: {}", t.getMessage());
    }
  }
  ...
  private static TranslationDecision computeTranslationDecision(String key) {
    if (VANILLA_TRANSLATIONS.contains(key) || ProtectorVanillaKeys.contains(key)) {
