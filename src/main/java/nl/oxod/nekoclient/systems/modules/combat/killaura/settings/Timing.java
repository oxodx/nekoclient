...
public class Timing {
  ...
  public final Setting<Boolean> pauseOnLag = sg.add(new BoolSetting.Builder()
      .name("pause-on-lag")
      .description("Pauses if the server is lagging.")
      .defaultValue(true)
      .build());

  public final Setting<Boolean> pauseOnUse = sg.add(new BoolSetting.Builder()
      .name("pause-on-use")
      .description("Does not attack while using an item.")
      .defaultValue(false)
      .build());

  public final Setting<Boolean> pauseOnCA = sg.add(new BoolSetting.Builder()
      .name("pause-on-CA")
      .description("Does not attack while CA is placing.")
      .defaultValue(true)
      .build());

  public final Setting<Boolean> tpsSync = sg.add(new BoolSetting.Builder()
      .name("TPS-sync")
      .description("Tries to sync attack delay with the server's TPS.")
      .defaultValue(true)
      .build());

  public final Setting<Boolean> customDelay = sg.add(new BoolSetting.Builder()
      .name("custom-delay")
      .description("Use a custom delay instead of the vanilla cooldown.")
      .defaultValue(false)
      .build());

  public final Setting<Integer> hitDelay = sg.add(new IntSetting.Builder()
      .name("hit-delay")
  ...
  public final Setting<Integer> switchDelay = sg.add(new IntSetting.Builder()
      .name("switch-delay")
